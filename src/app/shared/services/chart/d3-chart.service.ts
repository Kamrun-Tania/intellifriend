...
export class D3ChartService {
  ...
  public getBarChartData(data = []): any[] {
    ...
    const returnSlots = slots.map(slot => {
      return {
        name: slot,
        productive: (!!timelog[slot] && !!timelog[slot]['productive']) ? (timelog[slot]['productive'] / 60 * 20) : 0,
        unproductive: (!!timelog[slot] && !!timelog[slot]['unproductive']) ? (timelog[slot]['unproductive'] / 60 * 20) : 0,
        neutral: (!!timelog[slot] && !!timelog[slot]['neutral']) ? (timelog[slot]['neutral'] / 60 * 20) : 0,
        // series: [
        //   {
        //     name: 'productive',
        //     value: (!!timelog[slot] && !!timelog[slot]['productive']) ? (timelog[slot]['productive']/60) : 0,
        //   },
        //   {
        //     name: 'unproductive',
        //     value: (!!timelog[slot] && !!timelog[slot]['unproductive']) ? (timelog[slot]['unproductive']/60) : 0,
        //   },
        //   {
        //     name: 'neutral',
        //     value: (!!timelog[slot] && !!timelog[slot]['neutral']) ? (timelog[slot]['neutral']/60) : 0, 
        //   }
        // ]
      };
    });
